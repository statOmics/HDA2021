---
title: "High Dimensional Data Analysis 2021 (HDA2021)"
output:
    html_document:
        code_download: false
        toc: false
...
If you encounter any problems related to the course material (e.g. package installation problems, bugs in the code, typos, ...), please consider [posting an issue on GitHub](https://github.com/statOmics/HDA2021/issues).
